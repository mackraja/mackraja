...
|---------|-------------|------------|
| [E-Commerce Platform](https://github.com/mackraja/project-one) | Microservices-based scalable e-commerce platform | React.js · Node.js · PostgreSQL · AWS |
| [Real-Time Chat App](https://github.com/mackraja/project-two) | Desktop + web clients with real-time messaging | React.js · Electron.js · Node.js · Firebase |
| [Analytics Dashboard](https://github.com/mackraja/project-three) | Cloud-native dashboard for enterprise users | Angular · Node.js · MongoDB · GCP |
